...
public class QuestionThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = b.getParcelable("twoScore");
        ...
        String questionText = getResources().getString(R.string.question_three);
        ...
        submitButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                String answer_input_text = getResources().getString(R.string.answer_three).toLowerCase();
                ...
                Toast.makeText(QuestionThreeActivity.this, result + "", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(QuestionThreeActivity.this, QuestionFourActivity.class);
                Score mParcel = score;
                intent.putExtra("threeScore", mParcel);
